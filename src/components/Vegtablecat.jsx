...
import vegimage1 from '../images/vege cate 1.png';
import vegimage2 from '../images/vege cate 2.png';
import vegimage3 from '../images/vege cate 3.png';
import vegimage4 from '../images/vege cate 4.png';
import vegimage5 from '../images/vege cate 5.png';
import vegimage6 from '../images/vege cate 6.png';
import vegimage7 from '../images/vege cate 7.png';
import vegimage8 from '../images/vege cate 8.png';
...
const productsData = [
  { id: 1, imgSrc: vegimage1, title: 'Organic Beetroot', price: 80 },
  { id: 2, imgSrc: vegimage2, title: 'Organic Carrots', price: 100 },
  { id: 3, imgSrc: vegimage3, title: 'Organic Garlic', price: 150 },
  { id: 4, imgSrc: vegimage4, title: 'Organic Sweetcorn', price: 30 },
  { id: 5, imgSrc: vegimage5, title: 'Organic Spinach', price: 60 },
  { id: 6, imgSrc: vegimage6, title: 'Organic Tomatoes', price: 200 },
  { id: 7, imgSrc: vegimage7, title: 'Organic Beans', price: 90 },
  { id: 8, imgSrc: vegimage8, title: 'Organic Cabbage', price: 50 },
];

function Vegtablecat() {
                ...
                filteredProducts.map((product) => (
                        <article key={product.id} className="col-12 col-sm-6 col-md-4">
                            <div className="card h-100 shadow-sm rounded-3"> 
                              <Link className='productlink' to="/Vegidescript">
                              <img
                                src={product.imgSrc}
                                alt={product.title}
