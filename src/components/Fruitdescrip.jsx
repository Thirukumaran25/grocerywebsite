...
import fruitimg1 from '../images/fruit des 1.png'
import fruitimg2 from '../images/fruit des 2.png'
import fruitimg3 from '../images/fruit des 3.png'

const productsData = [
  { id: 81, imgSrc: fruitimg3, title: 'Country', price: 120 },
];


function Fruitdescrip() {
          ...
          <div className='eggdes1'>
              <div className='eggdesbox1'>
                  ...
                  <div className='eggdsbx2'>
                      <div>
                          <img src={fruitimg1} alt="" style={{width:"100%",height:"100%"}} />
                      </div>
                      <div>
                          <img src={fruitimg2} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                      <div>
                          <img src={fruitimg3} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                  </div>
              </div>
