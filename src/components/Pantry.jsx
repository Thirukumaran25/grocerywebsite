...
import pantryimg1 from "../images/pantry cate 1.png"
import pantryimg2 from "../images/pantry cate 2.png"
import pantryimg3 from "../images/pantry cate 3.png"
import pantryimg4 from "../images/pantry cate 4.png"
import pantryimg5 from "../images/pantry cate 5.png"
import pantryimg6 from "../images/pantry cate 6.png"
import pantryimg7 from "../images/pantry cate 7.png"
import pantryimg8 from "../images/pantry cate 8.png"
...
const productsData = [
  { id: 41, imgSrc: pantryimg1, title: 'Organic Beetroot', price: 80 },
  { id: 42, imgSrc: pantryimg2, title: 'Organic Carrots', price: 100 },
  { id: 43, imgSrc: pantryimg3, title: 'Organic Garlic', price: 150 },
  { id: 44, imgSrc: pantryimg4, title: 'Organic Sweetcorn', price: 30 },
  { id: 45, imgSrc: pantryimg5, title: 'Organic Spinach', price: 60 },
  { id: 46, imgSrc: pantryimg6, title: 'Organic Tomatoes', price: 200 },
  { id: 47, imgSrc: pantryimg7, title: 'Organic Beans', price: 90 },
  { id: 48, imgSrc: pantryimg8, title: 'Organic Cabbage', price: 50 },
];
          ...
          <div className="container" style={{ maxWidth: '1200px' }}>
            <div className="row mb-4">
              ...
              <section className="col-md-9 px-5">
                <h2 className="fs-4 fw-bold" style={{ color: '#4EB528', textDecoration: "underline" }}>Pantry & Staples</h2>
                    ...
                    filteredProducts.map((product) => (
                          <article key={product.id} className="col-12 col-sm-6 col-md-4">
                            <div className="card h-100 shadow-sm rounded-3"> 
                              <Link className='productlink' to="/Pantrydescrip">
                              <img
                                src={product.imgSrc}
                                alt={product.title}
