...
import bakeryimg1 from '../images/bakery cate 1.png'
import bakeryimg2 from '../images/bakery cate 2.png'
import bakeryimg3 from '../images/bakery cate 3.png'
import bakeryimg4 from '../images/bakery cate 4.png'
import bakeryimg5 from '../images/bakery cate 5.png'
import bakeryimg6 from '../images/bakery cate 6.png'
import bakeryimg7 from '../images/bakery cate 7.png'
import bakeryimg8 from '../images/bakery cate 8.png'
import {Link} from 'react-router-dom'
import './Bakery.css'

const productsData = [
  { id: 33, imgSrc: bakeryimg1, title: 'Organic Beetroot', price: 80 },
  { id: 34, imgSrc: bakeryimg2, title: 'Organic Carrots', price: 100 },
  { id: 35, imgSrc: bakeryimg3, title: 'Organic Garlic', price: 150 },
  { id: 36, imgSrc: bakeryimg4, title: 'Organic Sweetcorn', price: 30 },
  { id: 37, imgSrc: bakeryimg5, title: 'Organic Spinach', price: 60 },
  { id: 38, imgSrc: bakeryimg6, title: 'Organic Tomatoes', price: 200 },
  { id: 39, imgSrc: bakeryimg7, title: 'Organic Beans', price: 90 },
  { id: 40, imgSrc: bakeryimg8, title: 'Organic Cabbage', price: 50 },
];
                    ...
                    filteredProducts.map((product) => (
                        <article key={product.id} className="col-12 col-sm-6 col-md-4">
                                    <div className="card h-100 shadow-sm rounded-3"> 
                                      <Link className='productlink' to="/Backerdescrip">
                                      <img
                                        src={product.imgSrc}
                                        alt={product.title}
