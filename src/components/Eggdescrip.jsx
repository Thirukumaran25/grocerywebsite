...
import eggdesimg1 from "../images/dairy des 1.png"
import eggdesimg2 from "../images/dairy des 2.png"
import eggdesimg3 from "../images/dairy des 3.png"
import './Eggdes.css'
import { cartContext } from '../App'

const productsData = [
  { id: 79, imgSrc: eggdesimg3, title: 'Country', price: 120 },
];
        ...
        <div className='eggdes1'>
            <div className='eggdesbox1'>
                ...
                <div className='eggdsbx2'>
                    <div>
                        <img src={eggdesimg1} alt="" style={{width:"100%",height:"100%"}} />
                    </div>
                    <div>
                        <img src={eggdesimg2} alt="" style={{width:"100%",height:"100%"}}/>
                    </div>
                    <div>
                        <img src={eggdesimg3} alt="" style={{width:"100%",height:"100%"}}/>
                    </div>
                </div>
            </div>
