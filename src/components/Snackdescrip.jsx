...
import snackimg1 from "../images/snack des 1.png"
import snackimg2 from "../images/snack des 2.png"
import snackimg3 from "../images/snack des 3.png"

const productsData = [
  { id: 83, imgSrc: snackimg1, title: 'Country', price: 120 },
];


function Snackdescrip() {
          ...
          <div className='eggdes1'>
              <div className='eggdesbox1'>
                  ...
                  <div className='eggdsbx2'>
                      <div>
                          <img src={snackimg1} alt="" style={{width:"100%",height:"100%"}} />
                      </div>
                      <div>
                          <img src={snackimg2} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                      <div>
                          <img src={snackimg3} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                  </div>
              </div>
