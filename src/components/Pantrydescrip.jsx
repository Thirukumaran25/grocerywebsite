...
import pantrimg1 from "../images/pantry des 1.png"
import pantrimg2 from "../images/pantry des 2.png"
import pantrimg3 from "../images/pantry des 3.png"

const productsData = [
  { id: 82, imgSrc: pantrimg3, title: 'Country', price: 120 },
];


function Pantrydescrip() {
          ...
          <div className='eggdes1'>
              <div className='eggdesbox1'>
                  ...
                  <div className='eggdsbx2'>
                      <div>
                          <img src={pantrimg1} alt="" style={{width:"100%",height:"100%"}} />
                      </div>
                      <div>
                          <img src={pantrimg2} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                      <div>
                          <img src={pantrimg3} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                  </div>
              </div>
              <div className='eggdesbox2'>
                  <h4>Ground Turmeric Powder</h4>
