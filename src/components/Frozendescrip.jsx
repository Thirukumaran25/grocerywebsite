...
import frozonimg1 from '../images/frozen des 1.png'
import frozonimg2 from '../images/frozen des 2.png'
import frozonimg3 from '../images/frozen des 3.png'

const productsData = [
  { id: 80, imgSrc: frozonimg3, title: 'Country', price: 120 },
];


function Frozendescrip() {
          ...
          <div className='eggdes1'>
              <div className='eggdesbox1'>
                  ...
                  <div className='eggdsbx2'>
                      <div>
                          <img src={frozonimg1} alt="" style={{width:"100%",height:"100%"}} />
                      </div>
                      <div>
                          <img src={frozonimg2} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                      <div>
                          <img src={frozonimg3} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                  </div>
              </div>
