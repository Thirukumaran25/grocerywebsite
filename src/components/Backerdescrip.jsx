...
import backeryimg1 from '../images/bakery des 1.png'
import backeryimg2 from '../images/bakery des 2.png'
import backeryimg3 from '../images/bakery des 3.png'

const productsData = [
  { id: 78, imgSrc: backeryimg3, title: 'Country', price: 120 },
];


function Backerdescrip() {
          ...
          <div className='eggdes1'>
              <div className='eggdesbox1'>
                  ...
                  <div className='eggdsbx2'>
                      <div>
                          <img src={backeryimg1} alt="" style={{width:"100%",height:"100%"}} />
                      </div>
                      <div>
                          <img src={backeryimg2} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                      <div>
                          <img src={backeryimg3} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                  </div>
              </div>
