...
import fruitimg1 from '../images/fruits cate 1.png'
import fruitimg2 from '../images/fruits cate 2.png'
import fruitimg3 from '../images/fruits cate 3.png'
import fruitimg4 from '../images/fruits cate 4.png'
import fruitimg5 from '../images/fruits cate 5.png'
import fruitimg6 from '../images/fruits cate 6.png'
import fruitimg7 from '../images/fruits cate 7.png'
import fruitimg8 from '../images/fruits cate 8.png'
import {Link} from 'react-router-dom'
import './Bakery.css'


const productsData = [
  { id: 9, imgSrc: fruitimg1, title: 'Organic Beetroot', price: 80 },
  { id: 10, imgSrc: fruitimg2, title: 'Organic Carrots', price: 100 },
  { id: 11, imgSrc: fruitimg3, title: 'Organic Garlic', price: 150 },
  { id: 12, imgSrc: fruitimg4, title: 'Organic Sweetcorn', price: 30 },
  { id: 13, imgSrc: fruitimg5, title: 'Organic Spinach', price: 60 },
  { id: 14, imgSrc: fruitimg6, title: 'Organic Tomatoes', price: 200 },
  { id: 15, imgSrc: fruitimg7, title: 'Organic Beans', price: 90 },
  { id: 16, imgSrc: fruitimg8, title: 'Organic Cabbage', price: 50 },
];
  ...
  const {cart,setCart}=useContext(cartContext)
        ...
        <div className="container" style={{ maxWidth: '1200px' }}>
          <div className="row mb-4">
            ...
            <section className="col-md-9 px-5">
              <h2 className="fs-4 fw-bold" style={{ color: '#4EB528', textDecoration: "underline" }}>Fruits</h2>
    ...
    <article key={product.id} className="col-12 col-sm-6 col-md-4">
                            <div className="card h-100 shadow-sm rounded-3"> 
                              <Link className='productlink' to="/Fruitdescrip">
                              <img
                                src={product.imgSrc}
                                alt={product.title}
