...
import vegimg1 from "../images/veg des 1.png"
import vegimg2 from "../images/veg des 2.png"
import vegimg3 from "../images/veg des 3.png"
import './Eggdes.css'
import { cartContext } from '../App'

const productsData = [
  { id: 84, imgSrc: vegimg3, title: 'Country', price: 120 },
];


function Vegidescript() {
          ...
          <div className='eggdes1'>
              <div className='eggdesbox1'>
                  ...
                  <div className='eggdsbx2'>
                      <div>
                          <img src={vegimg1} alt="" style={{width:"100%",height:"100%"}} />
                      </div>
                      <div>
                          <img src={vegimg2} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                      <div>
                          <img src={vegimg3} alt="" style={{width:"100%",height:"100%"}}/>
                      </div>
                  </div>
              </div>
