...
import frozenimg1 from "../images/frozen cate 1.png"
import frozenimg2 from "../images/frozen cate 2.png"
import frozenimg3 from "../images/frozen cate 3.png"
import frozenimg4 from "../images/frozen cate 4.png"
import frozenimg5 from "../images/frozen cate 5.png"
import frozenimg6 from "../images/frozen cate 6.png"
import frozenimg7 from "../images/frozen cate 7.png"
import frozenimg8 from "../images/frozen cate 8.png"
import {Link} from 'react-router-dom'
import './Bakery.css'

const productsData = [
  { id: 57, imgSrc: frozenimg1, title: 'Organic Beetroot', price: 80 },
  { id: 58, imgSrc: frozenimg2, title: 'Organic Carrots', price: 100 },
  { id: 59, imgSrc: frozenimg3, title: 'Organic Garlic', price: 150 },
  { id: 60, imgSrc: frozenimg4, title: 'Organic Sweetcorn', price: 30 },
  { id: 61, imgSrc: frozenimg5, title: 'Organic Spinach', price: 60 },
  { id: 62, imgSrc: frozenimg6, title: 'Organic Tomatoes', price: 200 },
  { id: 63, imgSrc: frozenimg7, title: 'Organic Beans', price: 90 },
  { id: 64, imgSrc: frozenimg8, title: 'Organic Cabbage', price: 50 },
];
          ...
          <div className="container" style={{ maxWidth: '1200px' }}>
            <div className="row mb-4">
              ...
              <section className="col-md-9 px-5">
                <h2 className="fs-4 fw-bold" style={{ color: '#4EB528', textDecoration: "underline" }}>Frozen Food</h2>
                    ...
                    filteredProducts.map((product) => (
                          <article key={product.id} className="col-12 col-sm-6 col-md-4">
                              <div className="card h-100 shadow-sm rounded-3"> 
                                <Link className='productlink' to="/Frozendescrip">
                                <img
                                  src={product.imgSrc}
                                  alt={product.title}
